              ...
              <div class="box">
                <div class="box-header with-border">
                  <div align="center"><img src="reporte/REPORTEa.jpg" style="width: 700px;" >
                    ...
                    <label><h1 class="box-title">REPORTE DE TODAS LAS  COMPRAS POR PRODUCTO</h1></label>
                  </div>
                  <center><h3 class="box-title">Reporte de Facturas {{$date}}</h3></center>
                  <center><h3 class="box-title">Producto: {{$nombre->nombre}}</h3></center>
                </div><!-- /.box-header -->
                <div class="box-body">
                 ...
                 @foreach($facturas as $factura)
                    <tr>
                      ...
                      <td align="center" style="width: 40px">$ <?php echo number_format($factura->subtotal,0); ?></td>
                    </tr>
                    <?php $total=$total+($factura->subtotal); ?>
                  @endforeach
                  </tbody>
